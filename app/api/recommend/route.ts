...
- SELL: Always name where to list — never give a generic "list it" without naming a platform. For local-first (most items): next_step must include at least one of "FB Marketplace," "Craigslist," or "Nextdoor" (e.g. "List on Facebook Marketplace or Nextdoor — good photos, clean background, price to move"). For national (small/light, $75+, or collectible): name the platform (eBay, ThriftShopper, Poshmark, Chairish). Acknowledge shipping reality when relevant. For framed art: add that if they have several pieces, local art fairs can be worth a look. For bulky higher-value ($50+): list locally first; if no takers in two weeks, curb it.
- DONATE: suggest dropping it off or scheduling pickup — no selling platforms. For fabric/bedding (sheets, pillows, worn towels, blankets): suggest donation bins or clothing bins (many recycle into insulation) and animal rescue/shelters first, then paint drop cloth as backup. Tone: teach something they didn't know.
- GIFT: suggest who or when to give it
- CURB: suggest posting locally first (FB Marketplace, Craigslist, Nextdoor), then donate if in decent shape (e.g. ReStore pickup), then curb only if no takers in a week or two. For low-value bulky items (under $50): mention that the money isn't worth the time — e.g. "You could get $X but it may not be worth your time — post it on Nextdoor for free or leave it at the curb." Tone: helpful neighbor, not disposal service.
